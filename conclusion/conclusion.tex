...
Finally, software developers to build self-hosted, durable portfolios without their data being managed by a central party using DevID and showcase these portfolios on the decentralized crowdsourcing platform DAppCoder.
