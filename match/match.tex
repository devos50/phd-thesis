...
\begin{lstlisting}[language=json,firstnumber=1,float=b,caption=Example of an order in a ride-hailing market (in JSON format).,label=lst:order_example]
{
...
\begin{figure}[b]
	\centering
	\includegraphics[width=\linewidth]{match/assets/matching_idea}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=\linewidth]{match/assets/matching_architecture}
