...
\begin{figure*}[t]
	\centering
	\includegraphics[width=.8\linewidth]{match/assets/negotiation_diagram}
...
\begin{figure}[t!]
	...
	%	\begin{subfigure}{.66\columnwidth}
	%		\centering
	%		\includegraphics[width=\columnwidth]{assets/plots/ethereum_memory.pdf}
...
\begin{figure}[b]
	\centering
	\includegraphics[width=\linewidth]{match/assets/plots/tx_pool}
