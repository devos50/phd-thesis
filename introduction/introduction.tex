...
We design, implement, evaluate and deploy five decentralized mechanisms that improve different aspects of existing blockchain-based marketplaces.\todo{beter uitleggen - geen 1:1 mapping}
...
We devise a system architecture with flexible validation and fraud policies.\todo{do not mention fraud?}
...
This chapter is based on the following publication: \todo{mention Pim Otte paper}
...
This chapter is based on the following publication: \todo{mention liquidity conference paper}
