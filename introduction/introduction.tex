...
It describes the process by which decision-making is delegated away from a central, authoritative entity, for example, shifting authority from a government to provinces or municipalities within a country.
...
The ability to act as trusted intermediaries is at the core of electronic markets and their services help to ensure that a trade between a buyer and seller who might not necessarily trust each other proceeds without issues.
...
This makes it challenging to get a representative impression of one's skills and introduces search frictions.
...
Other mechanisms introduced in this thesis also address fraud but these types of fraud are not related to trade settlement and are therefore not visualized in Figure~\ref{fig:thesis_overview}.
