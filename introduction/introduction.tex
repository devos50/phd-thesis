...
Blockchain technology had a profound impact on existing markets.
This paradigm shift started in 2008 when Satoshi Nakamoto introduced Bitcoin, a decentralized cash system.\footnote{A pseudonym. The real identity behind the pseudonym is (still) unknown.}
...
We now discuss the required components of blockchain-based marketplaces.
