...
Perhaps the most influential solution, Corda, is currently being deployed by R3, a consortium consisting of the world's leading financial institutions~\cite{r3corda}.
...
\begin{table*}[t]
	...
	\begin{tabular}{ |c|c|c|c| }
		...
		4 & Internet-of-Money & DAS5 & Android app (restricted access) \\ \hline
		5 & \Dappcoder{} + DevID & user trial & Desktop application \\ \hline
	\end{tabular}
...
We utilize an existing library for networking primitives and decentralized overlay engineering, fully developed and maintained by our lab.\footnote{See \url{https://github.com/tribler/py-ipv8}}
