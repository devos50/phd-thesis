...
Ethereum~\cite{wood2014ethereum}, a blockchain solution released in 2015, was the first platform that enables developers to write and deploy \emph{smart contracts} on the blockchain ledger.
...
This body of research tends to follow a theoretical approach through the use of bound analysis, formal proofs or protocol simulations.
...
For all of our proposed mechanisms, our goal is to build a solution that is ready for deployment and usable by end users.
