...
We decompose each aspect into commonly used mechanisms.\todo{remove one aspects}
...
\begin{figure*}[t]
	...
	\end{subfigure}
	\caption{Three approaches for matchmaking. Traders create offers and requests (coloured green and red respectively), which are matched by matchmakers (depicted in blue).\todo{poppetje -> server}}
...
\textbf{[RQ4] How can assets securely be exchanged between any blockchain without a trusted intermediary?}\todo{verwerk aspect keywords in RQs}
...
This thesis consists of seven chapters.\todo{contrib <-> fraud, explain}
...
Pim Otte, Martijn de Vos and Johan Pouwelse, \enquote{TrustChain: A Sybil-resistant scalable blockchain}, \emph{Future Generation Computer Systems, Special Issue on Cryptocurrency and Blockchain Technology}, 2017, Elsevier.\\
...
Our trial demonstrates that DevID is efficient at storing portfolio records.\todo{rol mitchell}
This chapter is based on the following publication:
