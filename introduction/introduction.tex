...
The most common DApp on the Ethereum blockchain is an ERC20 contract, which enables developers to issue and manage custom assets.
...
At the time of writing, the biggest cryptocurrency exchange is Binance, with a 24-hour volume of \$24 billion.\footnote{See \url{https://coinmarketcap.com/rankings/exchanges/}}
...
In certain scenarios there is a need for traditional trusted intermediaries to safeguard business processes, in particular in the highly regulated financial sector.
...
Driven by our focus on practicality, we have deployed each mechanism proposed in this thesis, either within a small group of colleagues or with an integration in the Tribler application~\cite{zeilemaker2011tribler}.
