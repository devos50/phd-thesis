...
A key problem in blockchain-based marketplaces is where to store the market information.
...
\emph{Federated matchmaking} is an alternative solution where instead of relying on a central matchmaker, multiple (independent) matchmakers individually maintain an order book.
...
Secure \emph{settlement} in blockchain-based marketplaces is a difficult research challenge.
...
The management of fraud is a crucial challenge in any marketplace and closely related to settlement.
...
The last identified research challenge in blockchain-based marketplaces is how to manage the digital identities of participants.
...
Driven by our focus on feasibility, we have deployed each mechanism proposed in this thesis, either to a small group of users or with an integration in Tribler~\cite{zeilemaker2011tribler}.
