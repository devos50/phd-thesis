...
These simulations enables us to evaluate a mechanism with many users and allows us to quickly replay longitudinal real-world traces (e.g., we evaluate fraud gains of the XChange mechanism by replaying a week of buy and sell orders).
...
The mechanisms described XChange, Internet-of-Money and DevID mechanisms are based on this earlier version of TrustChain.
...
Specifically, we have reorganized the storyline to focus more on the dAppCoder platform, and we included more technical details on created TrustChain transactions.\\
