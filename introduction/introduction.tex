...
Electronic marketplaces require a mechanism for data storage and dissemination.
Typical market data includes pricing and product information, and details of past transactions (which is often used to estimate the trustworthiness of market participants).
...
Loopring is an order sharing protocol where new orders are sent to one or more relays in a mesh network~\cite{Wang:wt}.
