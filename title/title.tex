...
\begin{tabular}{p{4.5cm}l}
    ...
    Prof.\ dr.\ ir.\ A.M. Kermarrec, & École polytechnique fédérale de Lausanne \\
    Dr.\ ir.\ A.\ Gervais, & Imperial College London \\
    Pr.\ François\ Taïani, & Inria Rennes \& Université de Rennes \\
    Dr.\ ir.\ D.G.J. Bongaerts, & Erasmus University Rotterdam \\
    
    \todo{TBD}, & Technische Universiteit Delft, reservelid \\ \\
...
\begin{tabular}{@{}p{0.2\textwidth}@{}p{0.8\textwidth}}
  \textit{Keywords:} & electronic markets, blockchain, fairness, matchmaking, trading, decentralization, disintermediation, money, e-commerce, decentralized finance \\[\medskipamount]
