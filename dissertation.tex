...
\NewDocumentCommand\emojifuji{}{
	\includegraphics[scale=0.15]{assets/fuji.png}
}

\NewDocumentCommand\emojicoffee{}{
	\includegraphics[scale=0.07]{assets/coffee.png}
}
