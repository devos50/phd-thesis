...
\newcommand{\Tribler}{P2PClient}
\newcommand{\TrialUsers}{81'000}
...
\bibliography{references_trustchain,references_match,references_xchange,references_iom,references_devid}
