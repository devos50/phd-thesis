...
Prior to elaborating how we can use the services of other users to realise real-time money transfers, we briefly explore the process of performing a payment with existing infrastructure.
